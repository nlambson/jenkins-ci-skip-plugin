Jenkins::Plugin::Specification.new do |plugin|
  plugin.name = "wip-skip"
  plugin.display_name = "WIP Skip Plugin"
  plugin.version = '0.0.2'
  plugin.description = 'Commits that have WIP anywhere in the commit messages will be skipped.'
  ...
  plugin.uses_repository :github => "nlambson/jenkins-ci-skip-plugin"
